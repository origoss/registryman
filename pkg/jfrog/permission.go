...
func (r *registry) getPermission(permissionName string) (*permissionConfiguration, error) {
	apiUrl := *r.parsedUrl
...
func (r *registry) deletePermission(projName string) error {
...
func (r *registry) createPermission(projName string, permission *permissionConfiguration) error {
